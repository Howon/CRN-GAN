...
def recursive_generator(generator_inputs, res):
...
def create_model(inputs, targets):
    ...
    with tf.variable_scope("generator") as scope:
        ...
        outputs = recursive_generator(inputs, GEN_RES)
...
def main():
    ...
    if a.mode == "export":
        ...
        with tf.variable_scope("generator"):
            batch_output = deprocess(recursive_generator(preprocess(batch_input), GEN_RES))
